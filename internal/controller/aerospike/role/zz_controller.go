...
import (
	...
	v1alpha1 "github.com/terasky-oss/provider-aerospike/apis/aerospike/v1alpha1"
	features "github.com/terasky-oss/provider-aerospike/internal/features"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["aerospike_role"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
